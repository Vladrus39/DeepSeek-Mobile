...
- Tasks panel syncs active PC-host running tasks and can stop them through PC Host
...
- Автоматические live/SSE updates для task UI вместо ручной PC sync
...
- Последний локальный полный прогон: 128 mobile tests, 166 core tests, 2 pc-host tests
